...
from road_planning.agents.urban_planning_agent import UrbanPlanningAgent
...
flags.DEFINE_enum('agent', 'rl-sgnn',
                  ['rl-sgnn', 'rl-dgnn', 'rl-ngnn', 'rl-mlp', 'rl-rmlp',
                   'random', 'rule-centralized', 'rule-decentralized', 'ga'],
                  'Agent type.')
